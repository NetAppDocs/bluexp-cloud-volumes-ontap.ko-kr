...
최대 500GiB의 용량을 제공하는 Cloud Volumes ONTAP를 무료로 사용할 수 있는 Freemium 오퍼링을 선택하십시오. link:concept-licensing.html#packages["Freemium 제품에 대해 자세히 알아보십시오"].
...
+
프로비저닝된 용량 500GiB를 초과하지 않는 한, 마켓플레이스 구독을 통해 비용이 청구되지 않으며, 이 경우 시스템이 으로 자동으로 변환됩니다 link:concept-licensing.html#packages["Essentials 패키지를 선택합니다"].
...
용량 기반 라이센스를 통해 Cloud Volumes ONTAP 1TiB 용량 단위로 비용을 지불할 수 있습니다. 용량 기반 라이센스는 _ package_: Essentials, Optimized 또는 Professional 패키지의 형태로 제공됩니다.

Essentials, Optimized 및 Professional 패키지는 다음 소비 모델에서 사용할 수 있습니다.
...
link:concept-licensing.html#capacity-based-licensing["용량 기반 라이센스에 대해 자세히 알아보십시오"].
