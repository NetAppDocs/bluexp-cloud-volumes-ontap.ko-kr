...
Cloud Volumes ONTAP는 대부분의 Microsoft Azure 지역에서 지원됩니다. https://["지원되는 영역의 전체 목록을 봅니다"^].
...
https://["Azure에서 Cloud Volumes ONTAP에 대해 지원되는 구성입니다"^]
...
https://["Azure의 Cloud Volumes ONTAP에 대한 스토리지 제한"^]
...
이러한 디스크의 사용 사례에 대한 자세한 내용은 를 참조하십시오 https://["Microsoft Azure 설명서: Azure에서 사용할 수 있는 디스크 유형은 무엇입니까?"^].
