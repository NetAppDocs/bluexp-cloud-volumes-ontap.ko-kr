...
https://docs.netapp.com/us-en/cloud-volumes-ontap/reference_configs_azure_9101.html["Azure에서 Cloud Volumes ONTAP에 대해 지원되는 구성입니다"^]
...
https://docs.netapp.com/us-en/cloud-volumes-ontap/reference_limits_azure_9101.html["Azure의 Cloud Volumes ONTAP에 대한 스토리지 제한"^]
