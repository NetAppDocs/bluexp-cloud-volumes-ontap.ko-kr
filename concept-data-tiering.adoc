...
작업 환경을 생성할 때 스토리지 클래스를 선택하고 나중에 언제든지 변경할 수 있습니다. 저장소 클래스 변경에 대한 지침은 을 link:task-tiering.html["비활성 데이터를 저비용 오브젝트 스토리지로 계층화"]참조하십시오.
...
작업 환경을 생성할 때 스토리지 계층을 선택할 수 있으며 나중에 언제든지 변경할 수 있습니다. 스토리지 계층 변경에 대한 자세한 내용은 을 link:task-tiering.html["비활성 데이터를 저비용 오브젝트 스토리지로 계층화"]참조하십시오.
...
작업 환경을 생성할 때 스토리지 계층을 선택할 수 있으며 나중에 언제든지 변경할 수 있습니다. 스토리지 클래스 변경에 대한 자세한 내용은 을 link:task-tiering.html["비활성 데이터를 저비용 오브젝트 스토리지로 계층화"]참조하십시오.
