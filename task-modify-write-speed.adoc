...
모든 유형의 단일 노드 시스템에서는 높은 쓰기 속도가 지원됩니다. 특정 인스턴스 또는 VM 유형을 사용할 때는 AWS 및 Azure의 HA 쌍으로도 지원됩니다. GCP의 HA 쌍에서는 빠른 쓰기 속도가 지원되지 않습니다. https://docs.netapp.com/us-en/cloud-volumes-ontap/["자세한 내용은 Cloud Volumes ONTAP 릴리즈 노트 를 참조하십시오"^].
