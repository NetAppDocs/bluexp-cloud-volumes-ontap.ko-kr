...
https://docs.netapp.com/us-en/cloud-volumes-ontap/reference_configs_aws_9101.html["AWS에서 Cloud Volumes ONTAP가 지원되는 구성입니다"^]
...
https://docs.netapp.com/us-en/cloud-volumes-ontap/reference_limits_aws_9101.html["AWS의 Cloud Volumes ONTAP에 대한 스토리지 제한"^]
