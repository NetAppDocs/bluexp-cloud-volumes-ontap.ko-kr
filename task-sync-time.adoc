...
를 사용하여 NTP 서버를 지정합니다 https://docs.netapp.com/us-en/cloud-manager-automation/cm/api_ref_resources.html["BlueXP API"^] 또는 사용자 인터페이스에서 link:task-create-volumes.html#create-a-volume["CIFS 서버를 생성합니다"].
