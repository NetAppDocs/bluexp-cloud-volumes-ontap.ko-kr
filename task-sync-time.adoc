...
* link:task-manage-volumes.html#modifying-the-cifs-server["CIFS 서버 수정"]
* https://docs.netapp.com/us-en/cloud-manager-automation/index.html["Cloud Manager 자동화 문서"^]
