...
https://docs.netapp.com/us-en/cloud-volumes-ontap/reference_configs_gcp_9101.html["GCP에서 Cloud Volumes ONTAP에 지원되는 구성입니다"^]
...
https://docs.netapp.com/us-en/cloud-volumes-ontap/reference_limits_gcp_9101.html["GCP의 Cloud Volumes ONTAP에 대한 스토리지 제한입니다"^]
