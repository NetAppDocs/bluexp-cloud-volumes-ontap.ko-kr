...
summary: 기본적으로 Cloud Manager는 Cloud Volumes ONTAP 리소스와 Azure 리소스 간의 연결을 위해 Azure 프라이빗 링크를 활성화합니다. 필요한 경우 Azure Private Links를 비활성화하고 서비스 끝점을 대신 사용할 수 있습니다. 
---
...
[role="lead"]
기본적으로 Cloud Manager는 Cloud Volumes ONTAP 리소스와 Azure 리소스 간의 연결을 위해 Azure 프라이빗 링크를 활성화합니다. 필요한 경우 Azure Private Links를 비활성화하고 서비스 끝점을 대신 사용할 수 있습니다.



== 개요

Cloud Manager를 사용하면 Cloud Volumes ONTAP 노드와 다음 Azure 리소스 간의 연결을 위해 Azure 프라이빗 링크를 사용할 수 있습니다.

* Cloud Volumes ONTAP 및 관련 스토리지 계정 간의 접속
* 백업 및 데이터 계층화를 위한 Cloud Volumes ONTAP 및 Azure Blob 스토리지 간 연결


Azure Private Link는 Azure의 엔드포인트 간 연결을 보호하고 성능상의 이점을 제공합니다.
...
=== Cloud Volumes ONTAP 스토리지 계정에서 전용 링크 연결이 작동하는 방식
