...
* link:task-set-up-licensing-aws.html["Azure에서 Cloud Volumes ONTAP에 대한 라이센스를 설정합니다"]
...
* link:task-set-up-licensing-aws.html["Google Cloud에서 Cloud Volumes ONTAP에 대한 라이센스를 설정합니다"]
