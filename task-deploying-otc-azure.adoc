...
NOTE: 중국 지역의 경우 단일 노드 구축은 Cloud Volumes ONTAP 9.12.1 GA 및 9.13.0 GA에서만 지원됩니다. 이러한 버전을 최신 Cloud Volumes ONTAP 패치 및 릴리스로 업그레이드할 수 있습니다. 중국 지역에 최신 Cloud Volumes ONTAP 버전을 배포하려면 NetApp 지원에 문의하십시오. 이러한 지역에서는 NetApp에서 직접 구매한 라이선스만 지원됩니다.
