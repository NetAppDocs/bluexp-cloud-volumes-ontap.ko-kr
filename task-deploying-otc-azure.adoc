...
+
단일 노드 시스템의 경우 Cloud Volumes ONTAP를 구축할 가용성 영역을 선택할 수 있습니다. AZ를 선택하지 않으면 Cloud Manager에서 자동으로 AZ를 선택합니다.
...
| 가용성 영역 | 단일 노드 시스템의 경우 Cloud Volumes ONTAP를 구축할 가용성 영역을 선택할 수 있습니다. AZ를 선택하지 않으면 Cloud Manager에서 자동으로 AZ를 선택합니다. 
