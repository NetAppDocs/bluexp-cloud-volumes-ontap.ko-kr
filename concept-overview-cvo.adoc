...
+
https://docs.netapp.com/us-en/snapcenter/get-started/concept_snapcenter_overview.html["SnapCenter에 대해 자세히 알아보십시오"^]
...
https://bluexp.netapp.com/ontap-cloud["Cloud Volumes ONTAP에 대해 자세히 알아보십시오"^]
