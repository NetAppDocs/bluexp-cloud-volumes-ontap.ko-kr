...
이 페이지에 설명된 향상된 기능은 Cloud Volumes ONTAP 관리를 지원하는 Cloud Manager 기능에만 적용됩니다. https://docs.netapp.com/us-en/cloud-volumes-ontap-relnotes/index.html["Cloud Volumes ONTAP 릴리즈 노트를 참조하십시오"^] Cloud Volumes ONTAP 소프트웨어의 새로운 기능에 대해 알아봅니다.
...
출시 특별 요금이 만료되었으므로 이제 WORM 스토리지 사용 요금이 부과됩니다. 충전은 볼륨의 총 프로비저닝 용량에 따라 매시간 제공됩니다. 이는 신규 및 기존 Cloud Volumes ONTAP 시스템에 적용됩니다.
...
link:concept-netapp-accounts.html["NetApp 계정 에 대해 자세히 알아보십시오"].
...
https://docs.netapp.com/us-en/cloud-volumes-ontap-relnotes["AWS에서 지원되는 Cloud Volumes ONTAP 구성 보기"^].
...
https://docs.netapp.com/us-en/cloud-volumes-ontap-relnotes["GCP에서 Cloud Volumes ONTAP에 대해 지원되는 구성을 봅니다"^].
