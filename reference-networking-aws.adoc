...
Cloud Volumes ONTAP 노드에서 일상 작업을 위해 다음 엔드포인트에 연결하려면 아웃바운드 인터넷 액세스가 필요합니다.
...
| AWS 서비스와의 커뮤니케이션: | 표준 및 개인 모드. | Cloud Volumes ONTAP는 AWS에서 특정 BlueXP  작업을 수행하기 위해 AWS 서비스와 통신할 수 없습니다. 
...
| AWS 서비스와의 커뮤니케이션: | 제한된 모드. | Cloud Volumes ONTAP는 AWS에서 특정 BlueXP  작업을 수행하기 위해 AWS 서비스와 통신할 수 없습니다. 
|===
