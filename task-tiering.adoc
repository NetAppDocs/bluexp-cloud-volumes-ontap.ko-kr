...
.span class="image"><img src="https://raw.githubusercontent.com/NetAppDocs/common/main/media/number-2.png"[] Alt="Two"></span> Cloud Volumes ONTAP와 오브젝트 스토리지 간의 연결을 확인합니다
...
+
link:task-creating-gcp-service-account.html["서비스 계정 설정 방법에 대해 알아보십시오"].
...
NOTE: Cloud Manager에서 시스템을 생성할 때 데이터 계층화를 설정할 수 없는 경우에만 이 옵션이 표시됩니다.
