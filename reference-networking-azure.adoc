...
TIP: 커넥터에 대한 정보를 찾고 계십니까? https://docs.netapp.com/us-en/cloud-manager-setup-admin/reference-ports-azure.html["Connector에 대한 보안 그룹 규칙을 봅니다"^]
...
* https://docs.netapp.com/us-en/cloud-manager-setup-admin/task-quick-start-connector-azure.html["커넥터에 대한 네트워킹 요구 사항을 봅니다"^]
