...
여기에 나열된 버전 이외의 Cloud Volumes ONTAP 버전은 새 배포에서 사용할 수 없습니다. 업그레이드에 대한 자세한 내용은 를 참조하십시오 link:task-updating-ontap-cloud.html#supported-upgrade-paths["지원되는 업그레이드 경로"].
